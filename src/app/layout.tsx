        ...
        >
            <body className="min-h-screen bg-[#070a10] text-slate-100 antialiased">
                <div aria-hidden className="pointer-events-none fixed inset-0 -z-10">
                    ...
                    <div className="absolute inset-0 opacity-[0.10] bg-[repeating-linear-gradient(135deg,rgba(254,234,59,0.22)_0px,rgba(254,234,59,0.22)_9px,transparent_9px,transparent_18px)] [mask-image:radial-gradient(circle_at_60%_10%,black,transparent_65%)]" />
                </div>
